...
fun TransactionScreen(navController: NavController) {
    ...
    val categoryState by backStackEntry
        ?.savedStateHandle
        ?.getStateFlow("selected_category", "Clothing")
        ?.collectAsState() ?: remember { mutableStateOf("Clothing") }

    val transactionTypes = listOf("Income", "Spending", "Transfer")
